...
A real-time analytics dashboard with interactive charts, key metrics and automated reports.

## What we did

We developed the custom system, with the data and interface the team needs every day.
